...
var InputPertanyaan = /** @class */ (function (_super) {
    __extends(InputPertanyaan, _super);
    function InputPertanyaan(pertanyaan, name, idHTML, value) {
        var _this = _super.call(this) || this;
        _this.pertanyaan = pertanyaan;
        _this.name = name;
        _this.idHtml = idHTML;
        _this.name = name;
        _this.value = value;
...
var InputNumber = /** @class */ (function (_super) {
    ...
    function InputNumber(name, idHTML) {
        var _this = _super.call(this) || this;
        _this.name = name;
        _this.idHtml = idHTML;
        return _this;
    ...
    InputNumber.prototype.tampil = function () {
        return "<b>" + this.name + "</b><br><input type=\"number\" style=\"width: 30px;\" id=\"" + this.idHtml + "\" value = 0 min = 0>";
    };
