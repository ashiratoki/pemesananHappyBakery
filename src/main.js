...
var InputRadio = /** @class */ (function (_super) {
    ...
    function InputRadio(name, id, idHTML, value) {
    ...
    InputRadio.prototype.tampil = function () {
    ...
    InputRadio.prototype.getValue = function () {
        ...
        if (booleanChoice) {
            this.valueInput = document.getElementById(this.idHTML).value;
            return this.valueInput;
        }
        else {
...
var inputRadioRasaSweet = new InputRadio("rasa", "sweetRadio", "rasaSweet", "sweet");
var inputRadioRasaSavory = new InputRadio("rasa", "savoryRadio", "rasaSavory", "savory");
var inputRadioTeksturSoft = new InputRadio("tekstur", "softRadio", "teksturSoft", "soft");
var inputRadioTeksturCrunchy = new InputRadio("tekstur", "crunchyRadio", "teksturCrunchy", "crunchy");
...
//Push ke dalam menu
menu.push(muffin, fruitCrepes, kueBalok, brownies, donat, klemben, rotiAbon, pizza, garlicBread, croissant, rotiJagung, veggieCrepes, matcha, chocolate, lemonTea, coffee, milkTea);
function CetakNota() {
...
var divButtonCetakNota = document.getElementById("buttonCetakNota").innerHTML;
